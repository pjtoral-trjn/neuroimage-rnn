...
class Pipeline:
    ...
    def set_callbacks(self):
        ...
        early_stopping_cb = tf.keras.callbacks.EarlyStopping(monitor=monitor, patience=self.args.early_stop, mode=mode
    ...
    def set_metrics(self):
        ...
        if self.args.task_selection == Constants.multi_classification:
            self.metrics = [tf.keras.metrics.AUC(name="auc"), tf.keras.metrics.AUC(curve="PR", name="auc_pr"),
